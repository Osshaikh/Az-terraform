...
output "vm_ids" {
  ...
  value       = concat(azurerm_virtual_machine.vm_windows[*].id)
}
...
output "vm_zones" {
  ...
  value       = zipmap(concat(azurerm_virtual_machine.vm_windows[*].id), concat(azurerm_virtual_machine.vm_windows[*].zones))
}